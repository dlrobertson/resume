...
\begin{document}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            & & & $\bullet$ Used standard open source tools to debug and fix multiple memory errors\\
            & & & $\bullet$ Aided in the addition of Agent Based Vulnerability Management to IP360\\
            %CDC
            September & \multirow{2}{*}{-} & May & \multirow{2}{*}{\textbf{ORISE Fellow}, \textit{Centers for Disease Control and Prevention}}\\
            2014 & & 2016 &\\
            & & & $\bullet$ Created a library in \texttt{C++} using computer vision and machine learning techniques\\
        ...
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            \multicolumn{3}{c}{\multirow{3}{*}{2015}} & \textbf{Smoltcp} - Contributor\\
            & & & $\bullet$ Leading the effort to add IPv6 support.\\[2mm]
            ...
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
            \multicolumn{3}{c}{} & \textbf{\texttt{Rust, C/C++, Python, x86 Assembly, \LaTeX}}\\[-1mm]
            %Education
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
