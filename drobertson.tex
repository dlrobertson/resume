...
\begin{document}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            2014 & & &\\
            & & & $\bullet$ Created a framework in \texttt{C++} using computer vision and machine learning techniques with\\
            ...
            \\
            \multicolumn{3}{c}{\textbf{Languages}} & \textbf{\texttt{C/C++, Python, Scala, SQL, R, Bash, \LaTeX}}\\
            %Presentations
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
