...
\begin{document}
    ...
    \begin{table}[ht]
        ...
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            & & & $\bullet$ Submitted over 15 accepted commits to Servo\\
            \\
            ...
            & & & $\bullet$ Author of \texttt{bfork}, an \texttt{R} package for basic \texttt{Unix} process control.\\
            % Languages and Skillz
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
            & & & \large{\textbf{Languages \& Skills}}\\
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
            \multicolumn{3}{c}{} & \textbf{\texttt{Rust, C/C++, Python, Scala, SQL, x86 Assembly, \LaTeX}}\\
            %Education
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
